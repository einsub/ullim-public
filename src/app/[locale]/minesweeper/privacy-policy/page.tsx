    ...
    <article className="mx-auto max-w-lg px-6 py-16">
      ...
      <section className="mt-8 space-y-6 text-sm leading-relaxed text-neutral-600 dark:text-neutral-400">
        ...
        <div>
          ...
          <h3 className="mt-3 font-medium text-neutral-800 dark:text-neutral-300">{pp.gameCenterTitle}</h3>
          <p className="mt-1">
            {pp.gameCenter}{" "}
            <a href="https://www.apple.com/legal/privacy/" className="underline" target="_blank" rel="noopener noreferrer">
              {dict.common.applePrivacyPolicy}
            </a>
          </p>
        </div>
        <div>
          <h2 className="font-semibold text-neutral-900 dark:text-neutral-200">{pp.iapTitle}</h2>
