...
export default async function JotDailyPrivacyPolicy({
  params,
}: {
      ...
      <article className="mx-auto w-full max-w-lg py-16">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-white/70">
          ...
          <div>
            ...
            <h3 className="mt-3 font-medium text-white/80">{pp.googleDriveTitle}</h3>
            <p className="mt-1">
              {pp.googleDrive}{" "}
            ...
            <h3 className="mt-3 font-medium text-white/80">{pp.iapTitle}</h3>
            <p className="mt-1">
              {pp.iap}{" "}
