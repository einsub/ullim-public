...
export default async function ZuehanePrivacyPolicy({
  params,
}: {
  ...
  const pp = dict.zuehane.privacyPolicy;
      ...
      <article className="mx-auto w-full max-w-lg py-16">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-white/70">
          ...
          <div>
            ...
            <h3 className="mt-3 font-medium text-white/80">{pp.googleAuthTitle}</h3>
            <p className="mt-1">
              {pp.googleAuth}{" "}
          ...
          <div>
            <h2 className="font-semibold text-white/90">{pp.permissionsTitle}</h2>
            <p className="mt-1">{pp.permissions}</p>
          </div>
          <div>
            <h2 className="font-semibold text-white/90">{pp.securityTitle}</h2>
            <p className="mt-1">{pp.security}</p>
          </div>
          <div>
